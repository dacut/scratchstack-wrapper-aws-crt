...
pub struct AwsAllocator {
    pub(crate) inner: *const AwsCAllocator,
}
...
impl Default for AwsAllocator {
    fn default() -> Self {
        Self {
            inner: unsafe { aws_default_allocator() },
        }
    }
}
...
extern "C" {
    ...
    pub fn aws_mem_realloc(allocator: *const AwsCAllocator, ptr: *mut *mut c_void, oldsize: usize, newsize: usize) -> i32;
    pub fn aws_mem_tracer_new(allocator: *const AwsCAllocator, deprecated: *const c_void, level: AwsMemTraceLevel, frames_per_stack: usize) -> *const AwsCAllocator;
    ...
    pub fn aws_small_block_allocator_new(allocator: *const AwsCAllocator, multi_threaded: bool) -> *const AwsCAllocator;
